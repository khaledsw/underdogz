...
if ( ! function_exists( 'eventon_settings' ) ) {
	...
	function eventon_settings() {
		...
		if(!$eventon->evo_updater->is_activated('eventon')){
			echo '<div class="update-nag">'.__('Your eventON license is not saved. <a href="'.get_admin_url().'admin.php?page=eventon&tab=evcal_4">Enter License Now</a>','eventon').'</div>';
		}
