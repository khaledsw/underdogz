	...
	// HTML - date
		...
		<div id='evcal_dates' date_format='<?php echo $evcal_date_format[0];?>'>
			...
			<div class='evo_end_event evo_datetimes switch_for_evsdate'>
				...
				<!-- timezone value -->				
				<p style='padding-top:10px'><input type='text' name='evo_event_timezone' value='<?php echo (!empty($ev_vals["evo_event_timezone"]) )? $ev_vals["evo_event_timezone"][0]:null;?>' placeholder='<?php _e('Timezone text eg.PST','eventon');?>'/><label for=""><?php _e('Event timezone','eventon');?><?php $eventon->throw_guide( __('Timezone text you type in here ex. PST will show next to event time on calendar.','eventon'));?></label></p>
		...
		?>
			<div class='evcal_data_block_style1'>
				...
				<div class='evcal_db_data'>			
					...
					<p><input type='text' id='evcal_org_contact' name='evcal_org_contact' value="<?php echo (!empty($termMeta["evcal_org_contact"]) )? $termMeta["evcal_org_contact"]:null?>" style='width:100%' placeholder='<?php _e('eg. noone[at] thismail.com','eventon');?>'/><label for='evcal_org_contact'><?php _e('(Optional) Organizer Contact Information','eventon')?></label></p>
					...
					<div class='evo_metafield_image' style='padding-top:10px'>
						<p>
                    		...
                    		<label><?php _e('Event Organizer Image','eventon');?></label>
                    	</p>
                    </div>
