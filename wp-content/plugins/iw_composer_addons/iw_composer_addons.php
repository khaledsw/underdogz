...
/*
  ...
  Plugin URI: http://gmswebdesign.com
...
//            $class .= implode(' ', $settings['vc_single_param_edit_holder_class']);
        ...
        <div class="control-icon" onclick="jQuery('.iw-list-icon-wrap').slideToggle();">
            ...
            <div class="icon-filter">
                <input class="filter-input" placeholder="<?php echo __('Click to select new or search...', 'gmswebdesign'); ?>" type="text"/>
            </div>
        </div>
        <div style="clear:both;"></div>
        <div class="iw-list-icon-wrap" style="display:none;">
		<input name="<?php echo $name; ?>" type="text" placeholder="<?php echo __('Input font Awesome name exclude \'fa-\', Ex: desktop, diamond...', 'gmswebdesign'); ?>" value="<?php echo $value; ?>" class="iw-icon-input-cs <?php echo $class; ?>">
