...
if (!class_exists('Inwave_Infor_Banner')) {
    class Inwave_Infor_Banner
    {
        ...
        function infor_banner_init()
        {
            ...
            vc_map(array(
                'name' => 'Info Banner',
                'description' => __('Add a banner & some information', 'gmswebdesign'),
                ...
                'params' => array(
                    array(
                        'type' => 'attach_image',
                        "heading" => __("Banner Image", "gmswebdesign"),
                        "param_name" => "img"
                    ),
                    array(
                        'type' => 'textfield',
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => __("Banner Size", "gmswebdesign"),
                        "param_name" => "img_size",
                        "description" => __("Enter image size. Example in pixels: 200x100 (Width x Height)", "gmswebdesign")
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Button Text", "gmswebdesign"),
                        "param_name" => "button_text"
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Link", "gmswebdesign"),
                        "param_name" => "link"
                    ),
                    array(
                        "type" => "dropdown",
