...
if (!class_exists('Inwave_Price_Box')) {
    class Inwave_Price_Box
    {
        ...
        function price_box_init()
        {
            ...
            vc_map(array(
                'name' => 'Price Box',
                'description' => __('Add a price box & some information', 'gmswebdesign'),
                ...
                'params' => array(
                    ...
                    array(
                        'type' => 'textfield',
                        "holder" => "div",
                        "heading" => __("Package name/Title", "gmswebdesign"),
                        "value" => "Lorem ipsum dolor sit amet",
                        "param_name" => "title"
                    ),
                    array(
                        'type' => 'textfield',
                        "heading" => __("Package type/Sub Title", "gmswebdesign"),
                        "value" => "",
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => __("Price", "gmswebdesign"),
                        "param_name" => "price"
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Read more text", "gmswebdesign"),
                        "param_name" => "readmore_text"
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Read more link", "gmswebdesign"),
                        "param_name" => "readmore_link"
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Purchase text", "gmswebdesign"),
                        "param_name" => "purchase_text"
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Purchase link", "gmswebdesign"),
