...
if (!class_exists('Inwave_History')) {
    class Inwave_History
    {
        ...
        function history_init()
        {
            ...
            vc_map(
                array(
                    "name" => __("History",'gmswebdesign'),
                    "base" => "inwave_history",
                    "content_element" => true,
                    'category' => 'gmswebdesign',
                    "description" => __("Add a set of history info and give some custom style.", "gmswebdesign"),
            ...
            vc_map(
                array(
                    "name" => __("History Item",'gmswebdesign'),
                    "base" => "inwave_history_item",
                    "class" => "inwave_history_item",
                    "icon" => "inwave_history_item",
                    'category' => 'gmswebdesign',
                    "description" => __("Add a item of history with some content and give some custom style.", "gmswebdesign"),
                    ...
                    "params" => array(
                        ...
                        array(
                            'type' => 'textfield',
                            "holder" => "div",
                            "heading" => __("Time point", "gmswebdesign"),
                            "value" => "2015",
                        ...
                        array(
                            ...
                            "heading" => __("Video/image embed code", "gmswebdesign"),
                            "param_name" => "media",
