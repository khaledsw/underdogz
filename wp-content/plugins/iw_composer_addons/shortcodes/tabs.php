...
if (!class_exists('Inwave_Tabs')) {
    class Inwave_Tabs
    {
        ...
        function tabs_init()
        {
            ...
            vc_map(
                array(
                    "name" => __("Tabs",'gmswebdesign'),
                    "base" => "inwave_tabs",
                    "content_element" => true,
                    'category' => 'gmswebdesign',
                    "description" => __("Add a set of tabs and give some custom style.", "gmswebdesign"),
            ...
            vc_map(
                array(
                    "name" => __("Tab Item",'gmswebdesign'),
                    "base" => "inwave_tab_item",
                    "class" => "inwave_tab_item",
                    "icon" => "inwave_tab_item",
                    'category' => 'gmswebdesign',
                    "description" => __("Add a list of tabs with some content and give some custom style.", "gmswebdesign"),
                     "as_child" => array('only' => 'inwave_tabs'),
                    "show_settings_on_create" => true,
                    "params" => array(
                        array(
                            'type' => 'attach_image',
                            "heading" => __("Tab Image", "gmswebdesign"),
                            "param_name" => "img"
                        ),
                        array(
                            'type' => 'textfield',
