...
if (!class_exists('Inwave_Navigation')) {
    class Inwave_Navigation
    {
        ...
        function navigation_init()
        {
            ...
            vc_map(
                array(
                    "name" => __("Navigation",'gmswebdesign'),
                    "base" => "inwave_navigation",
                    "content_element" => true,
                    'category' => 'gmswebdesign',
                    "description" => __("Add a menu and give some custom style.", "gmswebdesign"),
            ...
            vc_map(
                array(
                    "name" => __("Navigation Item",'gmswebdesign'),
                    "base" => "inwave_navigation_item",
                    "class" => "inwave_navigation_item",
                    "icon" => "inwave_navigation_item",
                    'category' => 'gmswebdesign',
                    "description" => __("Add a item for inwave navigation and give some custom style.", "gmswebdesign"),
