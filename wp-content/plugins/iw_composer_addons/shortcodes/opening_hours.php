...
if (!class_exists('Inwave_Opening_Hours')) {
    ...
    class Inwave_Opening_Hours {
        ...
        function opening_hours_init() {
            ...
            vc_map(
                    array(
                        "name" => __("Opening Hours",'gmswebdesign'),
                        "base" => "inwave_opening_hours",
                        "content_element" => true,
                        'category' => 'gmswebdesign',
                        "description" => __("Add a set of list opening hours and give some custom style.", "gmswebdesign"),
            ...
            vc_map(
                    array(
                        "name" => __("List Opening Item",'gmswebdesign'),
