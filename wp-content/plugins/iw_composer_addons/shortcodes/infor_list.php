...
if (!class_exists('Inwave_Infor_List')) {
    class Inwave_Infor_List
    {
        ...
        function infor_list_init()
        {
            ...
            vc_map(
                array(
                    "name" => __("Info List",'gmswebdesign'),
                    "base" => "inwave_infor_list",
                    "content_element" => true,
                    'category' => 'gmswebdesign',
                    "description" => __("Add a set of list info and give some custom style.", "gmswebdesign"),
            ...
            vc_map(
                array(
                    "name" => __("Info Item",'gmswebdesign'),
                    "base" => "inwave_infor_list_item",
                    "class" => "inwave_infor_list_item",
                    "icon" => "inwave_infor_list_item",
                    'category' => 'gmswebdesign',
                    "description" => __("Add a list of info with some content and give some custom style.", "gmswebdesign"),
