...
if (!class_exists('Inwave_Product_List')) {
    class Inwave_Product_List
    {
        function __construct()
        {
            ...
            add_action('admin_init', array($this, 'product_list_init'));
        ...
        {	
            ...
            vc_map(array(
                ...
                'description' => __('Add list of products', 'gmswebdesign'),
                ...
                'params' => array(
                    ...
                    array(
                        "type" => "textfield",
                        "heading" => __("Number of products", "gmswebdesign"),
                        "param_name" => "limit",
                        "value" => 12
                    ),
                    array(
                ...
                case 'layout2':
                    ...
                    if ($query->have_posts()):
                        while ($query->have_posts()) : $query->the_post();
                            ...
                            if($i%4==0 && $i>0) echo '</div><div class="row product-row-grid">';
                            $i++;
                            ?>
        ...
        function get_categories()
        {
            ...
            $newCategories = array();
            $newCategories[__("All", "gmswebdesign")] = '';
