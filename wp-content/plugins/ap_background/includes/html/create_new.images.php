...
<div class="group-content">
    <h2 class="title"><?php echo __('Image Sources', 'gmswebdesign'); ?></h2>
...
<div class="group-content image">
    <h2 class="title"><?php echo __('Image Gallery', 'gmswebdesign'); ?><span class="bt-ajax-loading add-item-ajax"><i class="fa fa-circle-o-notch fa-spin"></i></span></h2>
    <div class="content">
        ...
        <div class="control-buttons">
            <div class="create-button">
                <span class="button blue delete-selected"><i class="fa fa-times"></i> <?php echo __('DELETE SELECTED', 'gmswebdesign'); ?></span>
            </div>
            <div class="delete-button">
                <span class="button red delete-all"><i class="fa fa-times"></i> <?php echo __('DELETE ALL', 'gmswebdesign'); ?></span>
            </div>
        </div>
        <div style="clear: both"></div>
    </div>
...
<div class="group-content">
    <h2 class="title"><?php echo __('Layout settings', 'gmswebdesign'); ?></h2>
    <div class="content">
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Auto resize gallery', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Thumbnail width', 'gmswebdesign'); ?></div>
            <div class="control">
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Thumbnail process', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
                $thumProcess = array(
                    array('value' => 'none', 'text' => __('None', 'gmswebdesign')),
                    array('value' => 'crop', 'text' => __('Crop', 'gmswebdesign')),
                    array('value' => 'resize', 'text' => __('Resize', 'gmswebdesign')),
                    array('value' => 'resizekeepratio', 'text' => __('Resize keep ratio', 'gmswebdesign'))
                );
...
<div class="group-content">
    ...
    <div class="content">
        <div class="label" style="margin-bottom: 15px;"><?php echo __('Select effect for image gallery', 'gmswebdesign'); ?></div>
        <div class="control-group">
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Scroll direction', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
                $scrolldata = array(
                    array('value' => 'rtl', 'text' => __('Right to Left', 'gmswebdesign')),
                    array('value' => 'ltr', 'text' => __('Left to Right', 'gmswebdesign'))
                );
                ...
                ?>
                <span class="descript"><?php echo __('List image scroll direction.', 'gmswebdesign'); ?></span>
            </div>
            <div style="clear: both"></div>
        </div>
...
<div class="bt-parallax-get-media-item hidden">
    <div class="bg-type-list-wrap">
        <div class="get-from-wrap flickr" style="display: none;">
            <div class="header-title"><?php echo __('GET IMAGE FROM FLICKR', 'gmswebdesign'); ?></div>
            <div class="control-group">
                <div class="label"><?php echo __('Flickr API', 'gmswebdesign'); ?></div>
                <div class="control">
            ...
            <div class="control-group">
                <div class="label"><?php echo __('Username', 'gmswebdesign'); ?></div>
                <div class="control">
            ...
            <div class="control-group">
                <div class="label">
                    <?php echo __('Flickr Album', 'gmswebdesign'); ?>
        ...
        <div class="get-from-wrap facebook" style="display: none;">
            <div class="header-title"><?php echo __('GET IMAGE FROM FACEBOOK', 'gmswebdesign'); ?></div>
            <div class="control-group">
                <div class="label"><?php echo __('Facebook URL', 'gmswebdesign'); ?></div>
                <div class="control">
                    <input placeholder="<?php echo __('Facebook page profile URL', 'gmswebdesign'); ?>" id="facebook_uname" name="facebook_umame" value="" type="text"/>
                </div>
                <div style="clear: both"></div>
            </div>
            <div class="control-group">
                <div class="label">
                    <?php echo __('Facebook Album', 'gmswebdesign'); ?>
                    <span class="bt-ajax-loading load-album-item-ajax"><i class="fa fa-circle-o-notch fa-spin"></i></span>
                </div>
                <div class="control">
        ...
        <div class="get-from-wrap picasa" style="display: none;">
            <div class="header-title"><?php echo __('GET IMAGE FROM GOOGLE', 'gmswebdesign'); ?></div>
            <div class="control-group">
                <div class="label"><?php echo __('Username', 'gmswebdesign'); ?></div>
                <div class="control">
            ...
            <div class="control-group">
                <div class="label">
                    <?php echo __('Picasa Album', 'gmswebdesign'); ?>
                    <span class="bt-ajax-loading load-album-item-ajax"><i class="fa fa-circle-o-notch fa-spin"></i></span>
                </div>
                <div class="control">
        ...
        <div class="create-slideshow">
            <span class="button blue get-video"><?php echo __('GET IMAGES', 'gmswebdesign'); ?></span>
        </div>
    </div>
</div>
 <script>
