...
<div class="group-content">
    <h2 class="title"><?php echo __('Video Sources', 'gmswebdesign'); ?></h2>
    <div class="content">
...
<div class="group-content video">
    <h2 class="title"><?php echo __('Video Gallery', 'gmswebdesign'); ?><span class="bt-ajax-loading add-item-ajax"><i class="fa fa-circle-o-notch fa-spin"></i></span></h2>
    <div class="content">
    ...
    <div class="bg-type-list-wrap">
        <div class="get-from-wrap youtube" style="display: none;">
            ...
            <div class="control-group">
                <div class="label"><?php echo __('Google API', 'gmswebdesign'); ?></div>
                <div class="control">
        ...
        <div class="get-from-wrap vimeo" style="display: none;">
            <div class="header-title"><?php echo __('GET VIDEO FROM VIMEO', 'gmswebdesign'); ?></div>
            <div class="control-group">
        ...
        <div class="get-from-wrap embedcode" style="display: none;">
            <div class="header-title"><?php echo __('GET VIDEO WITH EMBED CODE', 'gmswebdesign'); ?></div>
            <div class="control-group">
        ...
        <div class="create-slideshow">
            <span class="button blue get-video"><?php echo __('GET VIDEO', 'gmswebdesign'); ?></span>
        </div>
    </div>
</div>
 <script>
