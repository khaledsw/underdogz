...
<div class="group-content">
    <h2 class="title"><?php echo __('General setting', 'gmswebdesign'); ?></h2>
    <div class="content">
        <div class="label" style="margin-bottom: 15px;"><?php echo __('Slider name and Dimentions', 'gmswebdesign'); ?></div>
        <div class="control-group">
            <div class="label"><?php echo __('Slider name', 'gmswebdesign'); ?></div>
            <div class="control">
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Alias name', 'gmswebdesign'); ?></div>
            <div class="control">
                <input type="text" value="<?php echo ($item->alias) ? $item->alias : ''; ?>" placeholder="<?php echo __('Auto generate from slider name', 'gmswebdesign'); ?>" name="alias_name"/>
            </div>
            <div style="clear: both"></div>
        </div>
        <div class="control-group">
            <div class="label"><?php echo __('Slider width', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
                $slider_size = array(
                    array('value' => 'auto', 'text' => __('Auto', 'gmswebdesign')),
                    array('value' => 'fixed', 'text' => __('Fixed width', 'gmswebdesign')),
                    array('value' => 'full', 'text' => __('Full width', 'gmswebdesign'))
                );
                ...
                <span><?php echo __('Slider height', 'gmswebdesign'); ?></span>
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Background type', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
                $bgdata = array(
                    array('value' => 'img', 'text' => __('Image background', 'gmswebdesign')),
                    array('value' => 'video', 'text' => __('Video background', 'gmswebdesign'))
                );
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Parallax background type', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
                $pbgdata = array(
                    array('value' => 'dynamic', 'text' => __('Dynamic parallax', 'gmswebdesign')),
                    array('value' => 'static', 'text' => __('Static parallax', 'gmswebdesign'))
                );
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Background content color', 'gmswebdesign'); ?></div>
            <div class="control">
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Enable parallax effect', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
                $enpadata = array(
        ...
        <div class="control-group">
            <div class="label"><?php echo __('Hide slider under width', 'gmswebdesign'); ?></div>
            <div class="control">
...
<div class="group-content img-background" style="<?php echo ($item->settings->bg_type == 'img') ? '' : 'display:none;'; ?>">
    <h2 class="title no-spacing-bottom"><?php echo __('Images background setting', 'gmswebdesign'); ?></h2>
    <div class="content">
        <div class="control-group">
            <div class="group-inner">
                <div class="label"><?php echo __('Background image', 'gmswebdesign'); ?></div>
                <div class="control">
            ...
            <div class="group-inner">
                <div class="label last"><?php echo __('Textured or color', 'gmswebdesign'); ?></div>
                <div class="control">
            ...
            <div class="group-inner">
                <div class="label last"><?php echo __('Opacity', 'gmswebdesign'); ?></div>
                <div class="control">
...
<div class="group-content video-background"  style="<?php echo ($item->settings->bg_type == 'video') ? '' : 'display:none;'; ?>">
    <h2 class="title no-spacing-bottom"><?php echo __('Video background setting', 'gmswebdesign'); ?></h2>
    <div class="content">
        <div class="control-group">
            <div class="group-inner">
                <div class="label first">
                    <?php echo __('Background video', 'gmswebdesign'); ?>
            ...
            <div class="group-inner">
                <div class="label last">
                    <?php echo __('Opacity', 'gmswebdesign'); ?>
        ...
        <div class="control-group">
            <div class="label" style="margin-top: 8px; text-align: left;"><?php echo __('Mute video', 'gmswebdesign'); ?></div>
            <div class="control">
                <?php
                $videodata = array(
                    array('value' => '1', 'text' => __('Yes', 'gmswebdesign')),
...
<!--Content setting-->
<div class="group-content">
    <h2 class="title"><?php echo __('Content setting', 'gmswebdesign'); ?></h2>
    <div class="content">
        <div class="control-group">
            <div class="label"><?php echo __('Content width', 'gmswebdesign'); ?></div>
            <div class="control">
                ...
                <span style="color: #c12c30; font-weight: bold;"><?php echo __('(Blank: 100%)', 'gmswebdesign'); ?></span>
            </div>
            <div style="clear: both"></div>
        </div>
        <div class="label"><?php echo __('Insert the text content here, for a better SEO result you can use heading tags for important contents', 'gmswebdesign'); ?></div>
        <div class="control-group">
            <?php
...
<div class="group-content">
    ...
    <div class="content">
        <div class="label" style="margin-bottom: 15px;"><?php echo __('Select effect for content text', 'gmswebdesign'); ?></div>
        <div class="control-group">
...
<div class="bt-parallax-select-bg-type hidden">
    <div class="bg-type-list-wrap">
        <div class="header-title"><?php echo __('GET VIDEO BACKGROUND', 'gmswebdesign'); ?></div>
        <div class="control-group">
            <div class="label"><?php echo __('Video Url', 'gmswebdesign'); ?></div>
            <div class="control">
        ...
        <div class="create-slideshow">
            <span class="button blue get-video-bg"><?php echo __('GET VIDEO', 'gmswebdesign'); ?></span>
        </div>
    </div>
</div>
...
<div class="bt-parallax-edit-media-gallery-item hidden">
    <div class="bg-type-list-wrap">
        <div class="get-from-wrap youtube" style="display: none;">
            <div class="header-title"><?php echo __('GET VIDEO FROM YOUTUBE', 'gmswebdesign'); ?></div>
            <div class="control-group">
                <div class="label"><?php echo __('Youtube URL', 'gmswebdesign'); ?></div>
                <div class="control">
        ...
        <div class="get-from-wrap vimeo" style="display: none;">
            <div class="header-title"><?php echo __('EDIT VIDEO', 'gmswebdesign'); ?></div>
            <div class="control-group">
                <div class="label"><?php echo __('Vimeo URL', 'gmswebdesign'); ?></div>
                <div class="control">
        ...
        <div class="get-from-wrap embedcode" style="display: none;">
            <div class="header-title"><?php echo __('EDIT VIDEO', 'gmswebdesign'); ?></div>
            <div class="control-group">
                <div class="label"><?php echo __('Embed code', 'gmswebdesign'); ?></div>
                <div class="control">
        ...
        <div class="get-from-wrap image-edit" style="display: none;">
            <div class="header-title"><?php echo __('EDIT IMAGE', 'gmswebdesign'); ?></div>
            <div class="control-group">
                <div class="label"><?php echo __('Image URL', 'gmswebdesign'); ?></div>
                <div class="control">
        ...
        <div class="create-slideshow">
            <span class="button blue edit-update-item"><?php echo __('OK', 'gmswebdesign'); ?></span>
        </div>
    </div>
</div>