...
// Register Custom Post Type
    function iw_courses_add_post_types_courses() {
        ...
        $labels = array(
            'name' => _x('Courses', 'Post Type General Name', 'gmswebdesign'),
            'singular_name' => _x('Courses', 'Post Type Singular Name', 'gmswebdesign'),
            'menu_name' => __('IW Courses', 'gmswebdesign'),
            'parent_item_colon' => __('Parent Item:', 'gmswebdesign'),
            'all_items' => __('All Courses', 'gmswebdesign'),
            'view_item' => __('View Item', 'gmswebdesign'),
            'add_new_item' => __('Add new', 'gmswebdesign'),
            'add_new' => __('Add New', 'gmswebdesign'),
            'edit_item' => __('Edit Item', 'gmswebdesign'),
            'update_item' => __('Update Item', 'gmswebdesign'),
            'search_items' => __('Search Item', 'gmswebdesign'),
            'not_found' => __('Not found', 'gmswebdesign'),
            'not_found_in_trash' => __('Not found in Trash', 'gmswebdesign'),
        );
        $args = array(
            'label' => __('iw_courses', 'gmswebdesign'),
            'description' => __('Post Type Description', 'gmswebdesign'),
            'labels' => $labels,
            'supports' => $support,
            'hierarchical' => true,
...
// Register Custom Post Type
    function iw_courses_add_post_types_teacher() {
        ...
        $labels = array(
            'name' => _x('Teachers', 'Post Type General Name', 'gmswebdesign'),
            'singular_name' => _x('Teacher', 'Post Type Singular Name', 'gmswebdesign'),
            'menu_name' => __('Teachers', 'gmswebdesign'),
            'parent_item_colon' => __('Parent Item:', 'gmswebdesign'),
            'all_items' => __('All Teacher', 'gmswebdesign'),
            'view_item' => __('View Item', 'gmswebdesign'),
            'add_new_item' => __('Add new', 'gmswebdesign'),
            'add_new' => __('Add New', 'gmswebdesign'),
            'edit_item' => __('Edit Item', 'gmswebdesign'),
        ...
        $args = array(
            'label' => __('iw_teacher', 'gmswebdesign'),
            'description' => __('Post Type Description', 'gmswebdesign'),
            'labels' => $labels,
            'supports' => $support,
            'hierarchical' => true,
...
if (!function_exists('iw_courses_add_taxonomy_class')) {
    ...
    function iw_courses_add_taxonomy_class() {
        ...
        $labels = array(
            'name' => _x($plural, 'taxonomy general name', 'gmswebdesign'),
            'singular_name' => _x($singular, 'taxonomy singular name', 'gmswebdesign'),
            'search_items' => sprintf(__('Search %s', 'gmswebdesign'), $plural),
//            'popular_items' => sprintf(__('Popular %s', 'gmswebdesign'), $plural),
            'all_items' => sprintf(__('All %s', 'gmswebdesign'), $plural),
            'parent_item' => null,
            'parent_item_colon' => null,
            'edit_item' => sprintf(__('Edit %s', 'gmswebdesign'), $singular),
            'update_item' => sprintf(__('Update %s', 'gmswebdesign'), $singular),
            'add_new_item' => sprintf(__('Add New %s', 'gmswebdesign'), $singular),
            'new_item_name' => sprintf(__('New %s Name', 'gmswebdesign'), $singular),
            'separate_items_with_commas' => sprintf(__('Separate %s with commas', 'gmswebdesign'), $plural),
            'add_or_remove_items' => sprintf(__('Add or remove %s', 'gmswebdesign'), $plural),
            'choose_from_most_used' => sprintf(__('Choose from the most used %s', 'gmswebdesign'), $plural)
        );
