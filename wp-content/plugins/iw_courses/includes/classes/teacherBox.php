...
class teacherBox {
    ...
    public function add_meta_box($post_type) {
        ...
        if ($post_type == 'iw_teacher') {
            add_meta_box(
                    'teacher_image_gallery', __('Image Gallery', 'gmswebdesign'), array($this, 'render_meta_box_image_gallery'), $post_type, 'advanced', 'high'
            );
            add_meta_box(
                    'teacher_basic_information', __('Basic Information', 'gmswebdesign'), array($this, 'render_meta_box_basic_information'), $post_type, 'advanced', 'high'
            );
            add_meta_box(
                    'teacher_info_training_skills', __('Training Skills', 'gmswebdesign'), array($this, 'render_meta_box_training_skills'), $post_type, 'advanced', 'high'
            );
            add_meta_box(
                    'teacher_info_training_experience', __('Training Experience', 'gmswebdesign'), array($this, 'render_meta_box_training_experience'), $post_type, 'advanced', 'high'
            );
            add_meta_box(
                    'teacher_social_link', __('Social Links', 'gmswebdesign'), array($this, 'render_meta_box_social_link'), $post_type, 'advanced', 'high'
            );
        }
    }
    ...
    public function render_meta_box_basic_information($post) {
        ...
        <div class="iwc-metabox-fields">
            <table class="list-table">
                <thead>
                    <tr>
                        <th class="left"><?php echo __('Text', 'gmswebdesign'); ?></th>
                ...
                <tbody class="the-list">
                    ...
                    <tr class="alternate">
                        <td>
                            <label><?php echo __('Teacher Rate', 'gmswebdesign'); ?></label>
                        </td>
                        <td colspan="2">
                            <?php
                    ...
                    <tr class="alternate">
                        <td>
                            <label><?php echo __('Teacher Email', 'gmswebdesign'); ?></label>
                        </td>
                        <td colspan="2">
                            <input value="<?php echo get_post_meta($post->ID, 'iw_teacher_email', true) ? get_post_meta($post->ID, 'iw_teacher_email', true) : ''; ?>" placeholder="<?php echo __('Teacher Email', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[teacher_email]"/>
                        </td>
                    </tr>
                    <?php if ($basic_info): ?>
                        <?php foreach ($basic_info as $info): ?>
                            ...
                            <tr class="alternate">
                                <td>
                                    <input value="<?php echo $info['key_title'] ? htmlspecialchars($info['key_title']) : ''; ?>" placeholder="<?php echo __('Info Title', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[basic_information][key_title][]"/>
                                </td>
                                <td>
                                    <input value="<?php echo $info['key_value'] ? htmlspecialchars($info['key_value']) : ''; ?>" placeholder="<?php echo __('Info Value', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[basic_information][key_value][]"/>
                                </td>
                                <td>
                    ...
                    <?php else: ?>
                        <tr class="alternate">
                            <td>
                                <input placeholder="<?php echo __('Info Title', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[basic_information][key_title][]"/>
                            </td>
                            <td>
                                <input placeholder="<?php echo __('Info Value', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[basic_information][key_value][]"/>
                            </td>
                            <td>
                                <span class="button remove-button"><?php echo __('Remove', 'gmswebdesign'); ?></span>
                            </td>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="submit">
                                <span class="button add-row info"><?php echo __('Add Info', 'gmswebdesign'); ?></span
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody class="the-list">
                    <?php if ($training_skills): ?>
                        <?php foreach ($training_skills as $skill): ?>
                            ...
                            <tr class="alternate">
                                <td>
                                    <input value="<?php echo $skill['key_title']; ?>" placeholder="<?php echo __('Training Skills Title', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[training_skills][key_title][]"/>
                                </td>
                                <td>
                                    <label class="field-value" style="font-weight: bold;"><?php echo $skill['key_value']; ?></label><br/>
                                    <input class="skill-field-value" value="<?php echo $skill['key_value']; ?>" placeholder="<?php echo __('Training Skills Value', 'gmswebdesign'); ?>" type="range" min="0" max="100" step="1" size="20" name="iw_information[training_skills][key_value][]"/>
                                </td>
                                <td>
                                    <span class="button remove-button"><?php echo __('Remove', 'gmswebdesign'); ?></span>
                                </td>
                    ...
                    <?php else: ?>
                        <tr class="alternate">
                            <td>
                                <input placeholder="<?php echo __('Training Skills Title', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[training_skills][key_title][]"/>
                            </td>
                            <td>
                                <label class="field-value" style="font-weight: bold;">50</label><br/>
                                <input class="skill-field-value" placeholder="<?php echo __('Training Skills Value', 'gmswebdesign'); ?>" type="range" min="0" max="100" step="1" size="20" value="50" name="iw_information[training_skills][key_value][]"/>
                            </td>
                            <td>
                                <span class="button remove-button"><?php echo __('Remove', 'gmswebdesign'); ?></span>
                            </td>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="submit">
                                <span class="button add-row skills"><?php echo __('Add Training Skills', 'gmswebdesign'); ?></span
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody class="the-list">
                    ...
                    if ($training_experience):
                        foreach ($training_experience as $exp):
                            ...
                            <tr class="alternate">
                                <td>
                                    <input value="<?php echo $exp['key_title']; ?>" placeholder="<?php echo __('Training Experience Title', 'gmswebdesign'); ?>" type="text" size="20" name="iw_information[training_experience][key_title][]"/>
                                </td>
                                <td>
                                    <textarea placeholder="<?php echo __('Training Experience Value', 'gmswebdesign'); ?>" name="iw_information[training_experience][key_value][]"><?php echo $exp['key_value']; ?></textarea>
                                </td>
                                <td>
                                    <span class="button remove-button"><?php echo __('Remove', 'gmswebdesign'); ?></span>
                                </td>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="submit">
                                <span class="button add-row experience"><?php echo __('Add Training Experience', 'gmswebdesign'); ?></span>
                            </div>
                        </td>
                    </tr>
                </tbody>
    ...
    public function render_meta_box_social_link($post) {
        ...
        $utility = new iwcUtility();
		$data = array(
			array('value' => 'facebook', 'text' => __('Facebook', 'gmswebdesign')),
			array('value' => 'youtube', 'text' => __('Youtube', 'gmswebdesign')),
			array('value' => 'vimeo', 'text' => __('Vimeo', 'gmswebdesign')),
			array('value' => 'flickr', 'text' => __('Flickr', 'gmswebdesign')),
			array('value' => 'google-plus', 'text' => __('Google+', 'gmswebdesign')),
			array('value' => 'linkedin', 'text' => __('Linkedin', 'gmswebdesign')),
			array('value' => 'tumblr', 'text' => __('Tumblr', 'gmswebdesign')),
			array('value' => 'twitter', 'text' => __('Twitter', 'gmswebdesign'))
		);
        ?>
        <div class="iwc-metabox-fields">
            <table class="list-table">
                <thead>
                    <tr>
                        <th class="left"><?php echo __('Social Type', 'gmswebdesign'); ?></th>
                        <th><?php echo __('Link', 'gmswebdesign'); ?></th>
                        <th></th>
                    </tr>
                </thead>
                <tbody class="the-list">
                    ...
                    if ($social_link):
                        foreach ($social_link as $exp):
                            ...
                            <tr class="alternate social-link-types">
                                ...
                                <td>
                                    <input type="url" placeholder="<?php echo __('Social Link Value', 'gmswebdesign'); ?>" name="iw_information[social_link][key_value][]" value="<?php echo $exp['key_value']; ?>"/>
                                </td>
                                <td>
                                    <span class="button remove-button"><?php echo __('Remove', 'gmswebdesign'); ?></span>
                                </td>
                        ...
                        <tr class="alternate social-link-types">
                            ...
                            <td>
                                <input type="url" placeholder="<?php echo __('Social Link Value', 'gmswebdesign'); ?>" name="iw_information[social_link][key_value][]" value=""/>
                            </td>
                            <td>
                                <span class="button remove-button"><?php echo __('Remove', 'gmswebdesign'); ?></span>
                            </td>
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="submit">
                                <span class="button add-row social"><?php echo __('Add Social', 'gmswebdesign'); ?></span>
                            </div>
                        </td>
                    </tr>
                </tbody>
