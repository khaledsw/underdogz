 ...
 * @developer duongca
 */
require (ABSPATH . 'wp-content/plugins/iw_courses/includes/utility.php');
get_header();
        ...
        <div class="container">
            <div class="row">
                            ...
                            <div data-ride="carousel" class="carousel slide" id="carousel">											
                                ...
                                <?php if (count($image_gallery) > 1): ?>
                                    ...
                                    <a data-slide="prev" role="button" href="#carousel" class="left carousel-control">
                                        ...
                                        <span class="sr-only"><?php echo __('Previous', 'gmswebdesign'); ?></span>
                                    </a>
                                    <a data-slide="next" role="button" href="#carousel" class="right carousel-control">
                                        <span aria-hidden="true" class="glyphicon glyphicon-chevron-right"></span>
                                        <span class="sr-only"><?php echo __('Next', 'gmswebdesign'); ?></span>
                                    </a>
                                <?php endif; ?>
                            </div>
                        </section>
                    ...
                    <div class="content-page">
                        <section class="class-details">
                            <div class="details-desc-title">
                                <h5><?php echo __('Class details', 'gmswebdesign'); ?></h5>
                        ...
                        <div class="share">
                            <div class="share-title">
                                <h5><?php echo __('Share This Class', 'gmswebdesign'); ?></h5>										
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                    <?php
                    $courses_teacher = get_post_meta($post->ID, 'iw_courses_teacher', true);
                    if ($courses_teacher):
                        ...
                        if ($teacher):
                            ...
                            <section class="class-trainer">
                                <div class="class-trainer-title">
                                    <h4><?php echo __('Class Trainer', 'gmswebdesign'); ?></h4>
                                ...
                                <div class="class-trainer-content">
                                    ...
                                    <a href="<?php echo $permalink; ?>" class="profile"><?php echo __('Profile', 'gmswebdesign'); ?></a>
                                </div>
                            </section>
                            <?php
                        endif;
                    ...
                    if ($extrafiels_data):
                        ...
                        <section class="class-info">
                            <div class="class-info-title">
                                <h4><?php echo __('Class Information', 'gmswebdesign'); ?></h4>
                            </div>
                            <?php
                            ...
                            ?>
                            <div class="course">
                                <span><?php echo __('Take This Course', 'gmswebdesign'); ?></span>
                            </div>
                            <div id="take-this-courses" style="display:none;">
                                ...
                                <form action="#" method="post">
                                    <div class="take-header">
                                        <div class="title"><?php echo __('TAKE THIS COURSE FORM', 'gmswebdesign'); ?></div>
                                    ...
                                    <div class="take-content">
                                        <div class="take-left">
                                            <a href="<?php echo get_term_link($post_cat[0]); ?>"><span><?php echo __('CHANGE COURSE', 'gmswebdesign'); ?></span></a>
                                            <input type="text" name="post_title" value="<?php echo get_the_title(); ?>" disabled="disabled" class="disabled">
                                            <input type="text" name="yname" required="required" placeholder="<?php echo __('Your name', 'gmswebdesign'); ?>">
                                            <input type="email" name="yemail" required="required" placeholder="<?php echo __('Your email', 'gmswebdesign'); ?>">
                                            <input type="text" name="ymobile" placeholder="<?php echo __('Your mobile', 'gmswebdesign'); ?>">
                                            <input type="hidden" name="teacher_email" value="<?php echo $courses_teacher; ?>">
                                        </div>
                                        <div class="take-right">
                                            <textarea name="ymessage"  required="required" placeholder="<?php echo __('Your message', 'gmswebdesign'); ?>"></textarea>
                                            <input onclick="sendTakeCourse();
                                                    return false" type="submit" value="<?php echo __('TAKE THIS COURSE', 'gmswebdesign'); ?>"/>
                                        </div>
                                    </div>
                                </form>
                                <div style="clear: both"></div>
                    ...
                    if ($courses):
                        ...
                        <section class="class-related">
                            <div class="class-related-title">
                                <h4><?php echo __('Class Related', 'gmswebdesign'); ?></h4>											
                            </div>
                            <div class="classes-content">
                                ...
                                foreach ($courses as $cour):
                                    ...
                                    $feature_img = wp_get_attachment_image_src(get_post_thumbnail_id($cour['key_value']), 'single-post-thumbnail');
                                    ?>
                                                ...
                                                <div class="table">
                                                    <div class="box-cell">
                                                        ...
                                                        <div class="box-details">
                                                            <a href="<?php echo $permalink; ?>"><?php echo __('Details', 'gmswebdesign'); ?></a>
                                                        </div>
                                                    </div>
                                                </div>	
                                            </div>
