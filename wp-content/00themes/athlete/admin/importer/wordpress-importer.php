...
<?php
	...
	function process_menu_item( $item ) {
		...
		$args = array(
			...
			/*'mmpm_item_style' => $mmpm_item_style,
			'mmpm_item_icon' => $mmpm_item_icon,
			'mmpm_disable_icon' => $mmpm_disable_icon,
			'mmpm_disable_text' => $mmpm_disable_text,
			'mmpm_disable_link' => $mmpm_disable_link,
			'mmpm_submenu_type' => $mmpm_submenu_type,
			'mmpm_submenu_post_type' => $mmpm_submenu_post_type,
			'mmpm_submenu_drops_side' => $mmpm_submenu_drops_side,
			'mmpm_submenu_columns' => $mmpm_submenu_columns,
			'mmpm_submenu_enable_full_width' => $mmpm_submenu_enable_full_width,
			'mmpm_submenu_bg_image' => $mmpm_submenu_bg_image*/
		);
		$id = wp_update_nav_menu_item( $menu_id, 0, $args );
		if ( $id && ! is_wp_error( $id ) ){
			$this->processed_menu_items[intval($item['post_id'])] = (int) $id;

			update_post_meta( $id, 'mmpm_item_style', sanitize_key($mmpm_item_style) );
			update_post_meta( $id, 'mmpm_item_icon', sanitize_key($mmpm_item_icon) );
			update_post_meta( $id, 'mmpm_disable_icon', sanitize_key($mmpm_disable_icon) );
			update_post_meta( $id, 'mmpm_disable_text', sanitize_key($mmpm_disable_text) );
			update_post_meta( $id, 'mmpm_disable_link', sanitize_key($mmpm_disable_link) );
			update_post_meta( $id, 'mmpm_submenu_type', sanitize_key($mmpm_submenu_type) );
			update_post_meta( $id, 'mmpm_submenu_post_type', sanitize_key($mmpm_submenu_post_type) );
			update_post_meta( $id, 'mmpm_submenu_drops_side', sanitize_key($mmpm_submenu_drops_side) );
			update_post_meta( $id, 'mmpm_submenu_columns', sanitize_key($mmpm_submenu_columns) );
			update_post_meta( $id, 'mmpm_submenu_enable_full_width', sanitize_key($mmpm_submenu_enable_full_width) );
			update_post_meta( $id, 'mmpm_submenu_bg_image', sanitize_key($mmpm_submenu_bg_image) );
		}
	}
