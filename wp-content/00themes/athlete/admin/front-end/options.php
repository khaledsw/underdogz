		...
		<div id="main">
			...
			<div id="content">
                ...
                <?php if(isset($_REQUEST['imported'])){
                    ...
                    echo '<p style="font-size:12px;">Option: You can also download original images <a href="http://inwavethemes.com/demo-images/athlete/original-images.zip">here</a> to replace grey demo images. Just unzip to the wordpress upload folder: wp-content/uploads</p>';
                }?>
		  	</div>
