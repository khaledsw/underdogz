...
function btParallaxBackgroundAddAdminMenu() {
    add_object_page(__('BT Advanced Parallax Background', 'inwavethemes'), __('AP Background', 'inwavethemes'), 'manage_options', 'bt-advance-parallax-background', 'pluginIndexRenderPage', plugins_url('assets/images/ap_icon.png',__FILE__));
