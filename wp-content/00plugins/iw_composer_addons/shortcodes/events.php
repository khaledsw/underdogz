        ...
        function heading_init() {
            ...
            vc_map(array(
                ...
                'params' => array(
                    ...
                    array(
                        'type' => 'textfield',
                        "heading" => __("Number of month", "inwavethemes"),
                        "value" => "5",
                        "param_name" => "months",
                        "description" => __('Number of month to get events.', "inwavethemes")
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => __("Number of events", "inwavethemes"),
                        "param_name" => "events",
                        "value" => "2",
                        "description" => __('Number of events to display on every month.', "inwavethemes")
                    ),
                    array(
                        "type" => "textfield",
