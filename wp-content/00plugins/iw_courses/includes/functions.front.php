...
<html>
<head>
  <title>' . __('Email recived from "TAKE THIS COURSE" form:', 'inwavethemes') . '</title>
</head>
<body>
  <p>' . __('Hi ' . $recived_name . ',', 'inwavethemes') . '</p>
  <p>' . __('This email was sent from "TAKE THIS COURSE" form', 'inwavethemes') . '</p>
  <table>
    <tr>
