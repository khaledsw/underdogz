        ...
        <form action="<?php echo esc_url(WC()->cart->get_cart_url()); ?>" method="post">
            ...
            <div class="cart-table">
                <div class="row-title">
                    ...
                    <div class="col-md-5"><span><?php _e('Product', 'woocommerce'); ?></span></div>
                    <div class="col-md-2"><span><?php _e('Price', 'woocommerce'); ?></span></div>
                    <div class="col-md-2"><span><?php _e('Quantity', 'woocommerce'); ?></span></div>
                    <div class="col-md-2"><span><?php _e('Total', 'woocommerce'); ?></span></div>
                    ...
                    if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
                        ...
                        ?>
                            ...
                            <div class="item delete-item col-md-1 col-sm-1 col-xs-12">
                                <?php
                                echo apply_filters('woocommerce_cart_item_remove_link', sprintf('<a href="%s" title="%s"><i class="fa fa-times-circle"></i></a>', esc_url(WC()->cart->get_remove_url($cart_item_key)), __('Remove this item', 'woocommerce')), $cart_item_key);
                                ?>
                            </div>
                        </div>
                    <?php
